...
W systemach, które nie nie posiadają randomizacji przestrzeni adresowej procesu wykrywanie ataków typu ROP jest możliwe poprzez monitorowanie
...
kompilowaniu programów w taki sposób, aby  zestaw instrukcji, z których się składają uniemożliwiał wykonanie ataku ROP \cite{Li}. Jednak tego typu metody 
są mało wydajne i powodują znaczący narzut na działanie systemu.
...
modułów pomocniczych, na przykład:
\begin{itemize}
\item shellcode'y na różne architektury procesorów, 
\item wykrywających wersję zainstalowanego oprogramowania na docelowym serwerze,
\item implementujących komunikację wybranymi protokołami, np. HTTP, FTP, SNMP, SMB, NTP,
\item moduły, które generują sekwencję danych wejściowych podczas ataków typu \textit{brute-force},
\item wykonujących popularne ataki typu DoS (ang. \textit{Denial of Service}), 
\item symulujących działanie serwerów m.in. MySQL, HTTP, DNS, POP3, SSH, IMAP, VNC,
\item narzędzi do obsługi komunikacji radiowej, np. Bluetooth, Wi-Fi.
\end{itemize}
...
powstał moduł typu payload i znajduje się w katalogu \verb+msf3/modules/payloads/singles/linux/armle+. Aby dodać powyższe moduły do frameworku 
...
powoduje istotne straty finansowe dla jego właściciela, dlatego często są oni skłonni zapłacić przestępcy okup, ani uniknąć ataku.
...
\bibitem[2]{Acri} E. Acri. \textit{Exploiting Arm Linux Systems}. \url{http://packetstormsecurity.com} \ %
\bibitem[3]{Avraham} I. Avraham. \textit{Non-Executable Stack ARM Exploitation}. Black Hat DC, 2011, \url{http://www.blackhat.com} \ %
\bibitem[4]{Buchanan} E. Buchanan, R. Roemer, H. Shacham, and S. Savage. \textit{When good instructions go bad: Generalizing return-oriented programming to RISC}. ACM Press, 2008, \url{http://cseweb.ucsd.edu/~hovav} \ %
...
\bibitem[6]{Davi} L. Davi, A. Dmitrienko, A.-R. Sadeghi, M. Winandy. \textit{Return-Oriented Programming without Returns on ARM}. 2010 \url{http://www.trust.informatik.tu-darmstadt.de} \ %
...
\bibitem[10]{Francillon} A. Francillon and C. Castelluccia. \textit{Code injection attacks on Harvard-architecture devices}. ACM Press, 2008, \url{http://arxiv.org} \ %
...
\bibitem[12]{Iozzo} V. Iozzo and R.P. Weinmann, \textit{CVE-2010-1119}, 2010, \url{http://packetstormsecurity.com} \ %
...
\bibitem[16]{Hulse} J. Hulse. \textit{Buffer Overflows: Anatomy of an Exploit}. \url{http://packetstormsecurity.com} \ %
\bibitem[17]{Hund} R. Hund, T. Holz, and F. Freiling. \textit{Return-oriented rootkits: Bypassing kernel code integrity protection mechanisms}. USENIX, 2009, \url{https://www.usenix.org} \ %
...
\bibitem[21]{Kumar} G. Kumar, A. Gupta. \textit{A Short Guide on ARM Exploitation}. \url{http://www.exploit-db.com} \ %
...
\bibitem[31]{Salwan} J. Salwan. \textit{How to Create a Shellcode on ARM Architecture}. \url{http://www.exploit-db.com/papers/15652/} \ %
...
\bibitem[44]{Niebezpiecznik} -. Niebezpiecznik o bezpieczeństwie i nie... \url{http://niebezpiecznik.pl} \ %
