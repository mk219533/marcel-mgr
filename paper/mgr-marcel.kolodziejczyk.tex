...
\verb+examples/2.1-buffer-overflow+. Program może być skompilowany poprzez wydanie poleceń:
\begin{verbatim}
$ cd examples/2.1-buffer-overflow
$ <ndk_root>/ndk-build
...
\bibitem[18]{Keith} MJ Keith, \textit{Android 2.0-2.1 Reverse Shell Exploit}. 2010, \url{http://www.exploit-db.com} \ %
