...
% Keith Makan
% http://es.slideshare.net/mjza/better-watch-your-apps-mj-keith
...
% opisac na czy polega blad
% parsowanie niestandardowej reprezentacji napisowej liczby zmienno przecinkowych
% opisac nan - sygnalizujacy i cichy
% co sie dzieje z wartoscia w argumencie NaN()
...
wykonania programu do rejestru R1 przybrał wartośc 0xdddddddd, która była dostarczona w treści strony HTML. Kolejna instrukcja, 
