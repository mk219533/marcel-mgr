...
trakcie ataku, natomiast adres powrotu zostanie nadpisany w taki sposób, aby wskazywał początek obszaru pamiąci na stosie zaalokowanego na bufor 
...
\SaveVerb{binsh}|"/system/bin/sh"|
\SaveVerb{libc}|libc.so|
\begin{print}
\begin{verbatim}
(gdb) x/s 0x003ad3a
0x3ad3a:	 "/system/bin/sh"
\end{verbatim}
\caption{Napis \protect\UseVerb{binsh} w bibliotece \protect\UseVerb{libc}.}
\label{print:binsh}
\end{print}
...
21: }
\end{verbatim}
\caption{Program przeprowadzający atak z wykorzystaniem \textit{return-oritented programming}}
\end{print}
