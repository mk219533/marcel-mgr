...
\item moduły wykrywające wersję zainstalowanego oprogramowania na docelowym serwerze,
\item moduły implementujące komunikację wybranymi protokołami, np. HTTP, FTP, SNMP, SMB, NTP,
\item moduły, które generują sekwencję danych wejściowych podczas ataków typu \textit{brute-force},
\item moduły wykonujące popularne ataki typu DoS (ang. \textit{Denial of Service}), 
\item moduły symulujące działanie serwerów m.in. MySQL, HTTP, DNS, POP3, SSH, IMAP, VNC,
\item obsługa komunikacji radiowej, np. Bluetooth, Wi-Fi.
\end{itemize}
...
\bibitem[11]{Iozzo} V. Iozzo and R.P. Weinmann, \textit{CVE-2010-1119}, 2010, \url{http://packetstormsecurity.com} \ %
\bibitem[12]{janic} P. Janic. \textit{Kompilator ROP}. praca magisterska, Uniwersytet Warszawski, 2012 \ %
\bibitem[13]{soldierx} jip@soldierx.com. \textit{Stack Smashing On A Modern Linux System}. \url{http://www.soldierx.com/tutorials/Stack-Smashing-Modern-Linux-System} \ %
\bibitem[14]{Hobarth} S. Höbarth, R. Mayrhofer. \textit{A framework for on-device privilege escalation exploit execution on android}, 3rd International Workshop on Security and Privacy in Spontaneous Interaction and Mobile Phone Use, colocated with Pervasive, 2011, \url{http://www.medien.ifi.lmu.de/iwssi2011/} \ %
\bibitem[15]{Hulse} J. Hulse. \textit{Buffer Overflows: Anatomy of an Exploit}. \url{http://packetstormsecurity.com} \ %
\bibitem[16]{Hund} R. Hund, T. Holz, and F. Freiling. \textit{Return-oriented rootkits: Bypassing kernel code integrity protection mechanisms}. USENIX, 2009, \url{https://www.usenix.org} \ %
\bibitem[17]{Keith} MJ Keith, \textit{Android 2.0-2.1 Reverse Shell Exploit}, 2010, \url{http://www.exploit-db.com} \ %
\bibitem[18]{Kornau} T. Kornau. \textit{Return oriented programming for the ARM architecture}. praca magisterska, Ruhr-Universität Bochum, 2010, \url{http://zynamics.com/downloads/kornau-tim--diplomarbeit--rop.pdf} \ %
\bibitem[19]{Krahmer} S. Krahmer. \textit{x86-64 buffer overflow exploits and the borrowed code chunks exploitation technique}, 2005. \url{http://www.suse.de/~krahmer} \ %
\bibitem[20]{Kumar} G. Kumar, A. Gupta. \textit{A Short Guide on ARM Exploitation}. \url{http://www.exploit-db.com} \ %
\bibitem[21]{Larochelle} D. Larochelle, D. Evans \textit{Statically Detecting Likely Buffer Overflow Vulnerabilities}. USENIX, 2001, \url{http://www.usenix.org} \ %
\bibitem[22]{Lhee} K. Lhee, S.J. Chapin. \textit{Type-Assisted Dynamic Buffer Overflow Detection}. USENIX, 2002, \url{http://www.usenix.org} \ %
\bibitem[23]{Li} J. Li, Z. Wang, X. Jiang, M. Grace, S. Bahram. \textit{Defeating return-oriented rootkits with “return-less” kernels}. ACM Press, 2010, \url{http://www.researchgate.net} \ %
\bibitem[24]{Lidner} F. Lidner. \textit{Developments in Cisco IOS forensics}. CONFidence 2.0, 2009. \url{http://www.recurity-labs.com} \ %
\bibitem[25]{McDonald} J. McDonald. \textit{Defeating Solaris/SPARC non-executable stack protection}. Bugtraq, 1999, \url{http://seclists.org} \ %
\bibitem[26]{Mulliner} C. Mulliner, Ch. Miller. \textit{Fuzzing the Phone in your Phone}. Black Hat USA, 2009, \url{http://www.blackhat.com} \ %
\bibitem[27]{Nergal} Nergal. \textit{The advanced return-into-lib(c) exploits: PaX case study}. Phrack Magazine, 58(4), 2001, \url{http://www.phrack.org} \ %
\bibitem[28]{Roglia} G F. Roglia, L. Martignoni, R. Paleari, D. Bruschi. \textit{Surgically returning to randomized lib(c)}. Computer Security Applications Conference, 2009, \url{http://air.unimi.it} \ %
\bibitem[29]{Roemer} R. Roemer. \textit{Finding the bad in good code: Automated return-oriented programming exploit discovery}. praca magisterska, UC San Diego, 2009, \url{https://cseweb.ucsd.edu/~rroemer} \ %
\bibitem[30]{Salwan} J. Salwan. \textit{How to Create a Shellcode on ARM Architecture}. \url{http://www.exploit-db.com/papers/15652/} \ %
\bibitem[31]{Shacham} H. Shacham. \textit{The geometry of innocent flesh on the bone Return-into-libc without function calls (on the x86)}. ACM Press, 2007, \url{http://cseweb.ucsd.edu/~hovav} \ %
\bibitem[32]{Toth} T. Toth, C. Kruegel \textit{Accurate buffer overflow detection via abstract pay load execution}. Springer, 2002, \url{http://www.auto.tuwien.ac.at} \ %
\bibitem[33]{Trammel} D. ,,I)ruid'' Trammel. \textit{Metasploit Framework Telephony}. Black Hat USA, 2009, \url{http://www.blackhat.com} \ %
\bibitem[34]{Wagner} D. Wagner, J.S. Foster, E.A. Brewer, A. Aiken \textit{A First Step Towards Automated Detection of Buffer Overrun Vulnerabilities}. NDSS, 2000, \url{www.cs.berkeley.edu/~daw} \ %
\bibitem[35]{Younan} Y. Younan, P. Philippaerts. \textit{Alphanumeric RISC ARM shellcode}. Phrack, 66, 2009, \url{http://www.phrack.org} \ %
\bibitem[36]{android} -. Android project. \url{http://developer.android.com} \ %
\bibitem[37]{armman} -. ARM Ltd. \textit{Arm architecture reference manual.}, \url{http://www.arm.com} \ %
\bibitem[38]{armcall} -. ARM Ltd. \textit{Procedure call standard for the arm architecture.}, \url{http://www.arm.com} \ %
\bibitem[39]{cve} -. Common Vulnerabilities and Exposures (CVE). \url{http://cve.mitre.org} \ %
\bibitem[40]{exploitdb} -. Exploit Database. \url{http://www.exploit-db.com} \ %
\bibitem[41]{metasploit} -. Metasploit framework. \url{http://www.metasploit.com} \ %
\bibitem[42]{packetstorm} -. Packet Storm. \url{http://packetstormsecurity.com} \ %
\bibitem[43]{webkit} -. WebKit Open Source Project. \url{http://www.webkit.org} \ %
\end{thebibliography}
