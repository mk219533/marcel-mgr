...
przez domyślne aplikacje do przeglądania stron internetowych i przez programy obsługujące pocztę e-mail.  

CVE (ang. \textit{Common Vulnerabilities and Exposures}) jest katalogiem podatności oraz zagrożeń dotyczących bezpieczeństwa informacji w systemach 
