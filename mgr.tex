...
Android jest systemem operacyjnym i zestawem aplikacji dodykowanym przede wszystkim dla urządzeń przenośnych z ekranami dotykowymi, takimi jak np. smartphone, tablet. 
Jądro systemu, zpstało oparte na jądrze Linuksa. System ten został zaprojektowany i stworzony głównie z myślą o urządzeniach
...
W rozdziale tym zostaną opiane podstawy architektury procesorów ARM. Następnie zostanie omówiona architektura oraz model bezpieczeństwa systemu Android.

\section{Opis architektury ARM}
